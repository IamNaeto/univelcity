  ...
  return (
    <div className="w-full grid grid-cols-3 gap-4 border-separate border-spacing-1">
      {data.map((product) => (
        <div 
        key={product._id} 
        className="relative p-4 border bg-gray-800 rounded-md flex flex-col gap-3 cursor-pointer transition-transform duration-300 ease-in-out transform hover:scale-90"
